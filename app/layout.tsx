    ...
    <html lang="en">
      ...
      <nav>
        ...
        <ul className="nav__links active">
          ...
          <li className="link btn1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
            <Link href="./form">
              ...
              <li className="link">
                <a href="../Login/Login.html">
                  <button className="btn1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-ful">Login</button>
                </a>
              </li>
        </ul>
      </nav>
